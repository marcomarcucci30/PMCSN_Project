...
\todo[inline, color=green]{Inserire figura 2 (alto livello)}
...
\todo[inline, color=red]{Se confronta con la tabella sopra so cazzi. Che fare?}
...
In seguito per ogni fascia oraria viene riportato il grafico relativo al tempo medio di attesa nella coda Covid-19, mediata su i seed, per il modello base e il modello avanzato.
%----------------------------------------------------------------------------------------
